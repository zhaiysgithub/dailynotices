...
class UpdateDownloader extends AsyncTask<Void, Integer, Long> {
    ...
    protected Long doInBackground(Void... params) {
        ...
        try {
            ...
            } else if (!UpdateUtil.INSTANCE.verify(mTemp, mTemp.getName())) {
    ...
    void checkSpace(long loaded, long total) throws UpdateError {
        ...
        UpdateUtil.INSTANCE.log("need = " + (total - loaded) + " = " + total + " - " + loaded + "\nspace = " + storage);
    ...
    private long download() throws IOException, UpdateError {
        ...
        if (isCancelled()) {
            ...
            UpdateUtil.INSTANCE.log("download incomplete(" + mBytesTemp + " + " + bytesCopied + " != " + mBytesTotal + ")");
