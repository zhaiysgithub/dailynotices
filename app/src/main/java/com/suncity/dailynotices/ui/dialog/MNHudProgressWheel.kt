 ...
 * @Package: com.suncity.dailynotices.ui.dialog
 * @ClassName: MNHudProgressWheel
 * @Description: MNHudProgressWheel
 * @UpdateDate: 24/7/2019
 * 引用：https://github.com/Todd-Davies/ProgressWheel
 */
class MNHudProgressWheel : View {
    ...
    private fun parseAttributes(a: TypedArray) {
        ...
        circleRadius = a.getDimension(R.styleable.MNHudProgressWheel_mn_circleRadius, circleRadius.toFloat()).toInt()

        fillRadius = a.getBoolean(R.styleable.MNHudProgressWheel_mn_fillRadius, false)

        barWidth = a.getDimension(R.styleable.MNHudProgressWheel_mn_barWidth, barWidth.toFloat()).toInt()

        rimWidth = a.getDimension(R.styleable.MNHudProgressWheel_mn_rimWidth, rimWidth.toFloat()).toInt()

        val baseSpinSpeed = a.getFloat(R.styleable.MNHudProgressWheel_mn_spinSpeed, spinSpeed / 360.0f)
        spinSpeed = baseSpinSpeed * 360

        barSpinCycleTime =
            a.getInt(R.styleable.MNHudProgressWheel_mn_barSpinCycleTime, barSpinCycleTime.toInt()).toDouble()
