package com.suncity.dailynotices.islib.utils;
...
public class FileUtils {
    ...
    public static String createDir(String dirPath) {
        try {
            ...
            if (file.getParentFile().exists()) {
                LogUtils.INSTANCE.e("----- 创建文件夹" + file.getAbsolutePath());
                file.mkdir();
    ...
    public static String createFile(File file) {
        try {
            if (file.getParentFile().exists()) {
                LogUtils.INSTANCE.e("----- 创建文件" + file.getAbsolutePath());
                file.createNewFile();
                return file.getAbsolutePath();
            } else {
                createDir(file.getParentFile().getAbsolutePath());
    ...
    public static String getApplicationId(Context appContext) throws IllegalArgumentException {
        ...
        try {
            ...
            LogUtils.INSTANCE.e(appContext.getPackageName() + " " + applicationInfo.metaData.getString("APP_ID"));
