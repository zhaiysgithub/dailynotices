...
public class PreviewAdapter extends PagerAdapter {
    ...
    public View instantiateItem(ViewGroup container, final int position) {
        View root = View.inflate(activity, R.layout.is_item_pager_img_sel, null);
        final SimpleDraweeView photoView = root.findViewById(R.id.ivImage);
        ...
        if (config.multiSelect) {
            ...
            ivChecked.setOnClickListener(v -> {
                if (listener != null) {
    ...
    private void displayImage(SimpleDraweeView photoView, String path) {
